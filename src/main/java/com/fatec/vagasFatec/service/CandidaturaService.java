...
public class CandidaturaService {
    ...
    private CandidaturaResponseDTO converterCandidatura (Candidatura candidatura){
    ...
    public CandidaturaResponseDTO criarCandidatura (Long id_aluno, Long id_vaga){
        ...
        if (candidaturaRepository.existsByCandidatoIdAndVagaId(id_aluno, id_vaga)){
            throw new RegraDeNegocioVioladaException("Voce ja se inscreveu nesta vaga");
        }
    ...
    public void desistirCandidatura (Long id_aluno, Long id_vaga){
        Candidatura candidatura = candidaturaRepository.findByCandidato_IdAndVaga_Id(id_aluno,id_vaga).orElseThrow(() -> new DadosNaoEncontrados("Vaga não encontrada"));
        ...
        if (candidatura.getStatus() == StatusCandidatura.DESISTIU){
            throw new RegraDeNegocioVioladaException("Voce ja desistiu desta vaga");
        }
